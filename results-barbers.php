        ...
        <div id="wrapper">
            ...
            <div id="content" style="background-color: white; min-height: 300px;">
                ...
                if ($stmt->execute() > 0 && $stmt->rowCount() > 0) {
                    ...
                    ?>
                    <div style="font-size: 25px; margin:auto; position:relative; top:20px; width:150px;">Barbershop:<?php echo $barbershopName; ?></div>
                    <table style="margin:auto; border-bottom: 1.5px solid #ff442a; background-color: rgba(0,0,0,.6); position:relative; top:20px; width:277px;">
                        ...
                        <?php foreach ($results as $index): ?>
                            <tr>
                                <td style="text-align:center;"><a style="text-decoration:none; color:lightgrey;" href="profile.php?barber-id=<?php echo$index['BarberID'] ?>"><?php echo $index['BarberName'] ?></a></td>

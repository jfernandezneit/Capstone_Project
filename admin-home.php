                ...
                <div id="wrapper">
                    ...
                    <div id="content" style="background-color: white; min-height: 300px;">
                        <div style="width:50%; background-color: rgba(0,0,0,0.6);min-height: 100px; margin:auto; position:relative; top:20px;">
                            <form method="GET" action="admin-search-results.php" style="position:relative; left:25px; top:30px;">
                                <input type="text" name="search">
                                <input id="action1" type="radio" value="Customer" name="searchAction">
                                <label for="action1">Customer</label>
                                <input id="action2" type="radio" value="Barber" name="searchAction">
                                <label for="action2">Barber</label>
                                <input id="action3" type="radio" value="Barbershop" name="searchAction">
                                <label for="action3">Barbershop</label>
                                <br/>
                                <br/>
                                <input type="submit" name="submit">
                            </form>

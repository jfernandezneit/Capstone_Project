        ...
        <div id="wrapper">
            ...
            <div id="content" style="background-color: white; min-height: 350px;">
                <div style="width:100%; background-color:rgba(0,0,0,.6); position: relative; top: 50px; border-bottom: 1.5px solid #ff442a">
                    <div style="width:200px; margin:auto; font-size: 22px;">Current Avaialability</div>
                    <br/>
                    <?php 
                    $check1 = filter_input(INPUT_POST, 'ViewSchedule');
                    if(isset($check1)){
                    ...
                    ?>
                    <div style="width:100px; margin:auto;"><a href="set-availabledays.php" style="text-decoration: none; color:white;">Go Back</a></div>
                </div>

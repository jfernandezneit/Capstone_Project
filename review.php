        ...
        <div id="wrapper">
            ...
            <div id="content" style="background-color: white; min-height: 300px;">
                <div style="width:100%; background-color:rgba(0,0,0,.6); position: relative; top: 50px; border-bottom: 1.5px solid #ff442a">
                    <?php
                     $result = getCustomersAppointment();
                     foreach($result as $x):?>
                          <div style="width:100%; margin-left:350px;"><a style="text-decoration: none; color:white;" href="review-appointment.php?customer-id=<?php echo $x['CustomerID']?>&barber-id=<?php echo $x['BarberID']?>">Review This Appointment <span style="color:#ff442a;"><?php echo $x['Day']?></span>, <span style="color:#ff442a;"><?php echo $x['Time']?> </span></a></div>
                    <?php
                     endforeach;
                    ?>
                </div>
